        ...
        <div class="card-body">
            <form action="{{ route('designer.designs.update', $design) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $design->title) }}" required>
                            @error('title')
                ...
                <div class="form-group">
                    ...
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $design->image_path) }}" alt="{{ $design->title }}" style="max-height: 200px; max-width: 100%;" class="img-thumbnail">
                    </div>
